...
const Services = ({data}:ServicesProps) => {
  ...
  const ServiceCard = ({ data }: ServiceCardProps) => {
    ...
    return (
      <>
        <div className="flex flex-col p-6 lg:mx-1 sm:mx-auto max-w-lg text-center rounded-lg border shadow border-gray-600 xl:p-8 text-white bg-neutral-800 w-full">
